...
class Normalizer:
    ...
    def norm_pixel(self, v3: B3, c: B3, factor: B3_Factor) -> B3:
        ...
        r_n = int(round(v3.r + k * (255 - v3.r) if v3.r >= c.r else v3.r - k * v3.r))
        g_n = int(round(v3.g + k * (255 - v3.g) if v3.g >= c.g else v3.g - k * v3.g))
        b_n = int(round(v3.b + k * (255 - v3.b) if v3.b >= c.b else v3.b - k * v3.b))
